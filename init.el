...
(setq package-selected-packages
       '(all-the-icons dashboard highlight-indent-guides treemacs projectile rainbow-delimiters smex markdown-mode beacon corfu corfu-terminal catppuccin-theme fira-code-mode yasnippet))
